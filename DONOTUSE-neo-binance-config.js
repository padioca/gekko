...
config.mailer = {
  ...
  email: 'padioca@gmail.com',    // Your Gmail address
  muteSoft: true, // disable advice printout if it's soft
  ...
  password: 'rPedCcL0fkTX',       // Your Gmail Password - if not supplied Gekko will prompt on startup.
...
config.pushbullet = {
  ...
  key: 'o.3RdQavUmjle40srf92EzuAueCfCDYw9F',
    // your email, change it unless you are Azor Ahai
  email: 'padioca@gmail.com',
